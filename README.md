...
<!-- Dynamic Header -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Priyobrata%20Chatterjee&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=AI/ML%20Engineer%20|%20Full-Stack%20Developer%20|%20Product%20Enthusiast&descAlignY=52&descSize=18"/>

<!-- Social Badges -->
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/priyobrata-chatterjee/)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ui07xWizardOp)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:priyobratachatterjee146@gmail.com)
[![Profile Views](https://komarev.com/ghpvc/?username=ui07xWizardOp&style=for-the-badge&color=blueviolet&label=PROFILE+VIEWS)](https://github.com/ui07xWizardOp)

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=1000&color=3B82F6&center=true&vCenter=true&multiline=true&repeat=true&random=false&width=700&height=100&lines=🚀+Building+Intelligent+Systems+with+AI%2FML;🔬+Computer+Vision+%7C+NLP+%7C+LLMs+%7C+Generative+AI;💻+20%2B+Hackathons+%7C+15%2B+Production+Projects" alt="Typing SVG" />
...
class Priyobrata:
    def __init__(self):
        self.name = "Priyobrata Chatterjee"
        self.location = "Bhubaneswar, Odisha, India 🇮🇳"
        self.education = {
            "B.Tech": "KIIT University - CSE (2023-2027) | CGPA: 8.22",
            "Executive": "IIT Patna - Product Management & Agentic AI (2026)"
        }
        self.roles = ["AI/ML Engineer", "Full-Stack Developer", "Product Enthusiast"]
        
    def expertise(self):
        return {
            "AI/ML": ["Computer Vision", "NLP", "LLMs", "Generative AI", "Deep Learning"],
            "Development": ["Full-Stack Web", "REST APIs", "Microservices", "Cloud Native"],
            "Product": ["PRD Writing", "UX Research", "Agile/Scrum", "Product Strategy"]
        }
...
- 🏛️ **Role-based dashboards**: Doctor, Staff, Patient views
- 📊 Clinical workflow automation with real-time analytics
...
- 🤖 **AI-powered resume screening** with explainable scoring (0-100)
- 📅 Automated interview scheduling with calendar integration
- ✉️ AI-personalized candidate communication at scale
...
<img src="https://img.shields.io/badge/AI-Travel%20Tech-orange?style=flat-square" />

- 🗺️ **AI-generated personalized 3-day itineraries**
...
- 🎤 **Google Cloud STT/TTS** with Gemini LLM integration
- 📱 WhatsApp (Gupshup) & Voice call (Exotel) webhooks
...
<img src="https://img.shields.io/badge/ISRO-Space%20Tech-darkblue?style=flat-square" />

- ☁️ **Tropical Cloud Cluster (TCC) detection** from INSAT satellite data
- 🔮 Cloud motion prediction using **ConvLSTM & Diffusion Models**
...
- 👁️ **Computer vision pipeline** for prescription intake
- ✍️ Tesseract OCR for handwriting recognition
- 📦 Real-time inventory management
- ⚡ Target: **40% faster processing**, **60% fewer errors**
...
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=ui07xWizardOp&layout=compact&langs_count=8&theme=tokyonight&hide_border=true&bg_color=0D1117"/>

<img width="100%" src="https://github-readme-streak-stats.herokuapp.com/?user=ui07xWizardOp&theme=tokyonight&hide_border=true&background=0D1117" alt="GitHub Streak" />

<img width="100%" src="https://github-readme-activity-graph.vercel.app/graph?username=ui07xWizardOp&theme=tokyo-night&hide_border=true&bg_color=0D1117" alt="Contribution Graph" />
...
|------|--------------|------------|
| 🎨 **Design Head & Marketing Incharge** | IEEE CTSoc Society, KIIT | Led 5+ tech events, 15+ member teams |
| 🏃 **Competitive Developer** | 20+ Hackathons | NLP, EdTech, HealthTech, GeoAI domains |
| 📝 **Product Analyst** | Personal Projects | 10+ PRDs, Product teardowns, UI/UX case studies |
...
📧 **Email:** priyobratachatterjee146@gmail.com
